        ...
        for(key in oCity){
            ...
            for(var j=0,k = sortKey.length;j<k;j++){
                ...
                for(var i=0,n=oCity[key][sortKey[j]].length;i<n;i++){
                    str = '<a class="z-publicCityClick-href" href="javascript:void(0)">' + oCity[key][sortKey[j]][i] + '</a>';
                    odda.push(str);
                }
    ...
    linkEvent:function(){
        ...
        for(var i=0,n=links.length;i<n;i++){
            links[i].onclick = function(){
                 ...
                 *选中以后，设置地图 
                 */
                pageView.cityMapFun(this.innerHTML);
                ...
                if(flag==0){
                    ...
                    if(typeof lis == 'object' && lis['length'] > 0){
                        ...
                        if(bs && bs['length'] > 1){
			                 ...
			                 *选中以后，设置地图 输入时
			                 */
			                pageView.cityMapFun(bs[0].innerHTML);
    ...
    KeyboardEvent:function(event,keycode){
        ...
        switch(keycode){
            ...
            case 13: // enter键
                 ...
                 * 按下enter时候
                 */
                pageView.cityMapFun(Vcity.regExChiese.exec(lis[this.count].innerHTML)[0]);
    ...
    liEvent:function(){
        ...
        for(var i = 0,n = lis.length;i < n;i++){
            Vcity._m.on(lis[i],'click',function(event){ 
                 ...
                 * 点击下拉列表
                 */
                pageView.cityMapFun(Vcity.regExChiese.exec(target.innerHTML)[0]);
